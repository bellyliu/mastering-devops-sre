...
**Purpose:** Password hashing library with multiple algorithm support.

**Version:** `passlib[bcrypt]==1.7.4`, `bcrypt==4.0.1`

### Key Features Used

#### 4.1 Password Context Setup
```python
# app/auth.py
...
**What it does:**
- Creates password hashing context
- Uses bcrypt algorithm
- `deprecated="auto"` handles algorithm upgrades
